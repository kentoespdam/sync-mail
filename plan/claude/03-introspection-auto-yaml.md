...
- Dokumentasi `information_schema.columns` MariaDB 11.x (kolom tersedia dan semantik `EXTRA`)
- API mutakhir `ruamel.yaml` untuk preserve order + write komentar inline
- Strategi pencocokan tipe data yang aman antar versi MariaDB
